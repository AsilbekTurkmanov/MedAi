      ...
      <main className="flex-1 flex items-center justify-center p-6 relative">
        <div className="w-full max-w-md p-8 bg-slate-900/90 border border-slate-800 rounded-3xl shadow-2xl backdrop-blur-xl">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white">Welcome to MEDAI</h1>
            <p className="text-xs text-slate-400 mt-1">Sign in to your intelligent healthcare account</p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-slate-800 text-center">
            <span className="text-[11px] text-slate-500 block mb-3 font-semibold uppercase tracking-wider">
              Quick Demo Fill
            </span>
            <div className="flex gap-2 justify-center text-xs">
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-blue-950 text-blue-400 hover:bg-blue-900 border border-blue-800 transition-colors"
              >
                Patient
              </button>
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-teal-950 text-teal-400 hover:bg-teal-900 border border-teal-800 transition-colors"
              >
                Doctor
              </button>
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-indigo-950 text-indigo-400 hover:bg-indigo-900 border border-indigo-800 transition-colors"
              >
                Admin
              </button>
            </div>
